...
const basePoses: StudioPose[] = [
  ...
  { id: "closeup", title: "Close-Up Product Detail", description: "Same-face model crop focused on the most important product detail.", cameraAngle: "Face-to-waist detail framing", highlightedDetails: ["fabric", "neckline", "print or embroidery"], primaryReference: "fabric_pattern", purpose: "Prove material and construction quality", prompt: "Face-to-waist detail image with the same model face visible and critical product details in focus.", enabled: true },
];
