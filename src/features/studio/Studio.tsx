...
const basePoses: StudioPose[] = [
  ...
  { id: "closeup", title: "Natural Zoomed-Out Face & Vibe Shot", description: "A natural, zoomed-out candid moment with a beautiful, cute, Gen-Z-style face and genuine expression.", cameraAngle: "Eye-level, zoomed out to a natural half-to-full body view", highlightedDetails: ["natural expression", "face and vibe", "overall outfit read"], primaryReference: "front", purpose: "Social-first, scroll-stopping lifestyle image", prompt: "Natural, zoomed-out lifestyle shot - not a tight close-up - with a beautiful, cute, Gen-Z-style face and a genuine, natural expression.", enabled: true },
];
