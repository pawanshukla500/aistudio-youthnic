...
3. Gemini creates a garment-specific six-pose plan: hero front, side/three-quarter, authoritative back, creative Gen-Z editorial, product-detail close-up, and a garment-led showcase frame.
   - The sixth frame has no fixed subject. During analysis Gemini picks the single feature a buyer judges this product by - a yoke, neckline, sleeve, print, bottom-wear cut and flare, hem or border, dupatta, saree pallu or drape - and designs that frame around it, recording the choice in `showcasePlan`. It may not repeat the hero framing or the pose-5 close-up subject; a collision with pose 5 is automatically widened.
   - Those choices are scored by what the team does with them (approved, rejected, regenerated, or refused by QA) in `showcase_feature_outcomes`, and later analyses read that back as house taste.
