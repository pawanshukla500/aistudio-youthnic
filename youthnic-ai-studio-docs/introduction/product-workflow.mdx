...
flowchart TD
    ...
    S3 --> S4[4. 6-Pose Plan Configuration]
...
### Stage 4: 6-Pose Plan Configuration
The platform populates the standard 6-pose commercial plan:
...
- **Poses 2–6 Lock to Pose 1**: Subsequent poses reuse Pose 1 as a visual continuity anchor, ensuring 100% lighting, backdrop, and identity coherence.
...
- Download a packaged `.zip` archive containing all 6 poses named by SKU and pose index.
