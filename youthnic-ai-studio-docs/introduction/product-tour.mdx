...
<Steps>
  ...
  <Step title="Pose Compilation & Generation">
    The 6-pose commercial plan compiles into prompt contracts. Pose 1 establishes the visual anchor, and Poses 2–6 lock to that exact model, lighting, and setting.
  </Step>
...
graph TD
    ...
    Studio["📸 Studio<br/>Single-SKU 6-Pose AI Photoshoots"]
...
<Tabs>
  <Tab title="1. Studio">
    **Your Virtual Photography Studio.**
    ...
    - Generate complete 6-pose editorial contact sheets in minutes.
  ...
  <Tab title="6. History">
    **Comprehensive Generation Audit Trail.**
    ...
    <Frame caption="Youthnic AI Studio — Permanent Generation Archive with Complete 6-Pose Saree Photoshoot Set and Per-Pose Costs">
