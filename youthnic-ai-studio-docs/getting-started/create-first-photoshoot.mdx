...
Producing your first commercial-grade fashion photoshoot in Youthnic AI Studio takes under five minutes. This guide walks you through the initial configuration, garment photo uploads, AI garment analysis, and launching the six-pose photoshoot.
...
## Step 5: Review the Six-Pose Catalog Plan

Youthnic automatically pre-configures a balanced 6-shot e-commerce editorial plan based on the detected garment type:

[SCREENSHOT REQUIRED:
Page: Studio (/studio)
Exact State: Six-Pose Catalog Plan accordion expanded showing cards for Poses 1 through 6.
Exact UI Section: Six-Pose Catalog Plan card with pose thumbnails and toggle switches.
Recommended Crop: 1200x420 lower section of Studio.
Recommended Dimensions: 1200x420
Filename: studio-six-pose-plan.webp]
...
6. **Pose 6 — Garment-Led Showcase**: Chosen by the detected garment. A saree gets a drape-led pallu frame, an outfit with bottom wear gets a head-to-toe top-and-bottom frame, a short kurti or top gets a playful moment against the established backdrop, and a standalone long kurti or dress gets a full-length fall-and-fit frame.

---

## Step 6: Launch Generation & Monitor Output

Click **Generate Photoshoot** (6 Credits) at the top right sticky bar.
