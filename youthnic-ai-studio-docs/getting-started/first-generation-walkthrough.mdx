...
In this comprehensive walkthrough, we will produce a full 6-pose commercial catalog shoot for an **Embroidered Chanderi Silk Kurta Set** (SKU: `CK-SILK-204`). 
...
## 5. Reviewing the 6-Pose Catalog

Expand the **Six-Pose Catalog Plan** card:
...
Once all 6 poses are complete, hover over any tile to open the full-screen inspection lightbox:
...
<Tabs>
  ...
  <Tab title="Bulk Export ZIP">
    Click **Export All Assets (.ZIP)** on the studio action bar to download all 6 poses cleanly renamed using your SKU:
...
- Inspecting six-pose parameters
