...
- **Pose Standard Inheritance**: Assign default pose standards (e.g. 6-pose catalog for Anarkalis; 7-pose saree standard with pallu close-up for Kanchipuram silks).
