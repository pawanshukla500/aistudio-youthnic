...
| **VID-004** | `studio/regenerate-retry.mdx` | Regenerate a single pose with correction | 6 poses completed with Pose 4 flagged | Click Regenerate on Pose 4; enter user correction ("more visible hemline"); submit | Pose 4 re-queueing and updating to completed | 20s | `videos/studio/regenerate-pose.mp4` | No |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **TUT-001** | `getting-started/first-generation-walkthrough.mdx` | Complete Studio Photoshoot Tutorial | Sign in -> Open Studio -> Upload 5 product references -> Set SKU & category -> Run AI Analysis -> Review Product Identity & Styling Plan -> Review 6-Pose Plan -> Start Generation -> Live Progress -> Quality Validation -> Download ZIP | 3m 30s | `videos/getting-started/studio-end-to-end-tutorial.mp4` | Yes (or Subtitles) |
