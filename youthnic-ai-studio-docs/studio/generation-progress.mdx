...
[SCREENSHOT REQUIRED:
Page: Studio (/studio)
Exact State: Six pose tiles showing mixed states (Tile 1: Completed with green badge, Tile 2: Validating 80%, Tile 3: Generating 45%, Tile 4: Preparing, Tile 5: Queued, Tile 6: Queued).
...
- A browser push notification and in-app bell alert will notify you when all 6 poses have finished rendering.
