...
<CardGroup cols={2}>
  ...
  <Card title="Shared Architectural Set" icon="building">
    Choose the ambient backdrop (e.g. *Jaipur Sandstone Gallery* or *Clean White Cyclorama*). All 6 poses per colourway render within this consistent environment.
  </Card>
  ...
  <Card title="Shared Six-Pose Plan" icon="film">
    Applies the standardized 6-pose composition (Hero, 45°, Back, Editorial, Detail, Garment-Led Showcase) across every colourway in the batch.
  </Card>
</CardGroup>
