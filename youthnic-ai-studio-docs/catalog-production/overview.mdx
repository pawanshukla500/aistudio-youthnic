...
While the [Studio](/studio/overview) is optimized for bespoke single-garment photoshoots, **Catalog Production** is built for high-volume enterprise e-commerce pipelines. It enables fashion brands, manufacturers, and catalog agencies to produce complete 6-pose photoshoots across dozens of colourways and SKUs in a single automated batch.
...
2. **Generation (`generation`)**: GPU workers render the six-pose sequence for all ready colourways sequentially or concurrently.
