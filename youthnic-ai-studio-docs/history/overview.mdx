...
graph LR
    ...
    A --> C[Inspect Pose Sets & 4K Previews]
...
<Frame caption="Live Generation Archive on Youthnic AI Studio History — showing Saree Pose Production Set (Frontal, Three-Quarter, Rear Back View, Editorial Seated, Fabric Texture Closeup), Tokens, and Dollar Costs">
  <img src="/images/history-live-5poses.png" alt="Youthnic AI Studio History Archive — pose set" />
</Frame>
